...
from routes import file_routes, chat_routes, analytics_routes, user_routes, test_firebase
...
app.include_router(test_firebase.router, prefix="/test-firebase", tags=["FirebaseTest"])
